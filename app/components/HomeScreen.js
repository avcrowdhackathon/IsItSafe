...
class Home extends Component {
  ...
  componentDidUpdate() {
    console.log('updated');
    if (this.state.itemToSnapTo === true) {
      this.carousel.snapToItem(this.state.itemToSnapTo);
      this.setState({ itemToSnapTo: false });
    }
  }
      ...
      .then(jsonResponse => {
        ...
        if (jsonResponse.status === 'ok') {
          ...
          this.setState({
            ...
            itemToSnapTo: this.state.places.length - 2,
          });
